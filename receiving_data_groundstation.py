...
while True:
    try:
        while ser.in_waiting:
            ...
            with open('/home/cubesat/Desktop/gas_sensing_codebase/methane_gas_sensing_repo-main/recieved_data_from_methane_sensor.csv', 'a') as file:
                string_clean = string_data.split('b\'', 1)[1]
                string_clean = string_clean.split('\\n',1)[0]
                string_clean = string_clean.split('\\r',1)[0]
                string_clean = string_clean.split('\\xf4',1)[0]
                string_clean = string_clean.split('(',1)[1]
                string_clean = string_clean.split(')',1)[0]
                ...
                final_string = data_type + "," + data_point
                print(final_string)
