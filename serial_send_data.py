...
def get_last_timestamp(last_timestamp, serial_port):
    ...
    remove_null_lines("/home/demopi/Documents/gas_data.csv")
    with open("home/demopi/Documents/gas_data.csv",'r') as csv_file:
        if csv_file: 
    ...
    if len(data) == 0:
        ...
        for row in data:
            string_send = f"{row["timestamp"]), row["data_type"], data points: row["data_point"]}"
            ...
            with open("/home/demopi/Documents/last_sent_timestamp.txt",'w') as file:
...
def schedule_get_last_timestamp(ser_port):
    ...
    last_timestamp = ""
    with open("/home/demopi/Documents/last_sent_timestamp.txt",'r') as csv_file:
    ...
    while True:
        ...
        if now.minute == 0 or now.minute == 30 or now.minute == 59:
...
def main():
    while True:
        ...
        #ser = serial.Serial(port='/dev/ttyUSB0', baudrate=115200, timeout=.1)
            ...
            #ser = serial.Serial(port='/dev/serial1', baudrate=115200, timeout=.1)
            print("success")
